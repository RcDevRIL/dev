...
class _FeaturesPage extends StatelessWidget {
  ...
  final Iterable<ErgoLifeFeature> features;
  final ValueChanged<ErgoLifeFeature> onFeatureTap;

  @override
  Widget build(BuildContext context) {
    const double aspectRatio = 160.0 / 180.0;
    final List<ErgoLifeFeature> featuresList = features.toList();
      ...
      child: SingleChildScrollView(
        ...
        child: LayoutBuilder(
          builder: (BuildContext context, BoxConstraints constraints) {
            ...
            final int rowCount = (features.length + columnCount - 1) ~/ columnCount;
    ...
    return KeyedSubtree(
      ...
      child: Semantics(
        ...
        child: ListView(
          ...
          key: PageStorageKey<String>(feature.name),
          padding: EdgeInsets.only(top: 8.0, bottom: windowBottomPadding),
          children: kGalleryfeatureToDemos[feature].map<Widget>((GalleryDemo demo) {
...
class ErgoLifeHome extends StatefulWidget {
  const ErgoLifeHome({
    Key key,
    this.testMode = false,
    this.optionsPage,
  ...
  @override
  _ErgoLifeHomeState createState() => _ErgoLifeHomeState();
}

class _ErgoLifeHomeState extends State<ErgoLifeHome> with SingleTickerProviderStateMixin {
  static final GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
  AnimationController _controller;
  ErgoLifeFeature _feature;
  ...
  Widget build(BuildContext context) {
          ...
          child: Backdrop(
            ...
            frontAction: AnimatedSwitcher(
              ...
              child: _feature == null
                ...
                : IconButton(
                  ...
                  tooltip: 'Back',
                  onPressed: () => setState(() => _feature = null),
                ),
            ),
            ...
            frontLayer: AnimatedSwitcher(
              ...
              child: _feature != null
                ? _DemosPage(_feature)
                : _FeaturesPage(
                  features: kAllGalleryDemoCategories,
                  onFeatureTap: (ErgoLifeFeature feature) {
    ...
    assert(() {
      ErgoLifeHome.showPreviewBanner = false;
      return true;
    }());

    if (ErgoLifeHome.showPreviewBanner) {
      home = Stack(
        fit: StackFit.expand,
        children: <Widget>[
          home,
