...
class ErgoLifeOptions {
  ...
  bool operator ==(dynamic other) {
    if (runtimeType != other.runtimeType)
      return false;
    final ErgoLifeOptions typedOther = other;
...
class _ThemeItem extends StatelessWidget {
  ...
  final ErgoLifeOptions options;
  final ValueChanged<ErgoLifeOptions> onOptionsChanged;
...
class ErgoLifeOptionsPage extends StatelessWidget {
  const ErgoLifeOptionsPage({
    Key key,
    this.options,
